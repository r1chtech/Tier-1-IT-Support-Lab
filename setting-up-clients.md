...
- Right-click the network icon in the taskbar and select Open Network & Internet Settings. Click Change adapter options.
...
- Right-click the Start button and select System. Click Rename this PC (Advanced).
